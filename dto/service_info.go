...
type ServiceListInput struct {
	Info     string `json:"info" form:"info" comment:"关键词" example:""`
	PageNo   int    `json:"page_no" form:"page_no" comment:"页数" example:"1"`
	PageSize int    `json:"page_size" form:"page_size" comment:"每页条数" example:"20"`
}
